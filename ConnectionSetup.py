...
class Connection():
    """
    Class which takes in an xIMU3 device and opens a connection through UDP or TCP.
    """
    ...
    def connect(self):
        """
        Tries to establish a connection with the device using UDP and TCP protocols. 
        Returns true if either attempt was successful, false otherwise.
        """
        self.protocol = 'UDP'
        ...
        # self.protocol = 'TCP'
        # self.connection = ximu3.Connection(self.device.to_tcp_connection_info())
        # if self.open(): return True
